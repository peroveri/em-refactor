...
mod test {
    use super::super::{
        collect_field, collect_struct_patterns, get_source, get_struct_hir_id, StructFieldType
    };
    use super::*;
    ...
    fn init_test(tcx: TyCtxt<'_>) -> HirId {
        ...
        let patterns = collect_struct_patterns(tcx, struct_hir_id, StructFieldType::from(field, 0));
